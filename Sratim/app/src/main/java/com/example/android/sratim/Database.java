...
public class Database extends SQLiteOpenHelper {
    ...
    public Database() {
        super(MyApp.getContext(), "MoviesList", null, 1);
    }

    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE Movies(_id INTEGER PRIMARY KEY AUTOINCREMENT, subject TEXT NOT NULL, body REAL DEFAULT 0, url TEXT DEFAULT NULL)");
